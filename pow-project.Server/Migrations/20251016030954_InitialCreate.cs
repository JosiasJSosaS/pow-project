        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListCount = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_List_AspNetUsers_createdById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createdById = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MovieListlistId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comment_List_MovieListlistId",
                        column: x => x.MovieListlistId,
                        principalTable: "List",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movie_List_MovieListlistId",
                        column: x => x.MovieListlistId,
                        principalTable: "List",
                        principalColumn: "listId");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_MovieListlistId",
                table: "Comment",
                column: "MovieListlistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_List_createdById",
                table: "List",
                column: "createdById");

            migrationBuilder.CreateIndex(
                name: "IX_Movie_MovieListlistId",
                table: "Movie",
                column: "MovieListlistId");
        }
